...
var UserRepository = (function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        config = {
                            ...
                            url: "http://localhost:4003/api/users?".concat(queryFilter),
                            headers: {
                ...
                switch (_a.label) {
                    case 0:
                        config = {
                            method: 'get',
                            maxBodyLength: Infinity,
                            url: "http://localhost:4003/api/users/".concat(userId),
                            headers: {
                                authorization: constant_1.INTERNAL_TOKEN
                            }
                        };
    ...
    UserRepository.prototype.createCustomerUser = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var config, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
