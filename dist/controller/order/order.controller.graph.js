...
var OrderGraphController = (function () {
    ...
    OrderGraphController.prototype.getListOrders = function (filter) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.orderService.getListOrders(filter)];
                    case 1:
                        data = _a.sent();
                        return [2, {
                                message: 'success',
    ...
    return OrderGraphController;
}());
exports.default = OrderGraphController;
//# sourceMappingURL=order.controller.graph.js.map