...
var UserAccountService = (function () {
    ...
    UserAccountService.prototype.login = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var existsUserAccount, accessTokenPayload, isEqual, userData, accessToken;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!existsUserAccount) {
                            throw new graphql_1.GraphQLError('Account is not found', {
                        ...
                        if (!isEqual) {
                            throw new graphql_1.GraphQLError('Invalid login credential', {
                    ...
                    case 2:
                        userData = _a.sent();
                        if (!userData) {
                            throw new graphql_1.GraphQLError('User is not found', {
                                extensions: { code: 'UserNotFound' }
                            });
                        }
                        accessToken = jsonwebtoken_1.default.sign(accessTokenPayload, 'AUTH_ACCESS_SERCRET_KEY');
                        return [2, {
